Contributing to Akik Core
============================

The Akik Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Akik Core project, and is not to be
confused with overall Akik Network Protocol consensus changes.

Whether a pull request is merged into Akik Core rests with the project merge
...
Patches that change Akik consensus rules are considerably more involved than
...
Where a patch set proposes to change the Akik consensus, it must have been
...
The project leader is the release manager for each Akik Core release.
