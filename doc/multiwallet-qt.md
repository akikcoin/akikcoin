...
In order to support loading of multiple wallets in akik-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is akik.cpp.
...
Changes to akik.cpp
----------------------
akik.cpp is the entry point into akik-qt, and as such, will require some minor modifications to provide hooks for
