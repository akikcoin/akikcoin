                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received AKC from zAKC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAKC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAKIK));
