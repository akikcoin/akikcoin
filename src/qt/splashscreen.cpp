...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Akik Core");
    ...
    QString copyrightTextAkik = QChar(0xA9) +QString(tr("2018-2019")) + QString(tr(" The Akik Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextAkik);
