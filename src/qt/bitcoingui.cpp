                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Akik Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Akik address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and akik: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAKC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Akik Core"), this);
    aboutAction->setStatusTip(tr("Show information about Akik Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Akik"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Akik addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Akik addresses"));
    ...
    openAction->setStatusTip(tr("Open a Akik: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Akik Core help message to get a list with possible Akik command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Akik Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Akik network", "", count));
}
...
{
    QString strTitle = tr("Akik Core"); // default title
...
/** Creates context menu, its actions, and akiks up all the relevant signals for mouse events. */
