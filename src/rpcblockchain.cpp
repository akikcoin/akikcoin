...
Object blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zakikObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zakikObj.emplace_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.emplace_back(Pair("zAKIKsupply", zakikObj));
...
Value getrawmempool(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in akik\n"
...
Value getblock(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zAKIKsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zAKIK denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zAKIK denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zAKIK denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zAKIK denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zAKIK denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zAKIK denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zAKIK denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zAKIK denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zAKIK denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
Value gettxout(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of akik addresses\n"
            "     \"akikaddress\"   	 	(string) akik address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
