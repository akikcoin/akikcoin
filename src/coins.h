...
/** 
    ...
    ****Note - for Akik we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of akik coming in to a transaction
